...
public class BvhExample extends Applet{
   ...
   @Override
	...
	public void loadBvh() {
		...
		try {
			reader1 = new Reader(new File("src/main/resources/A_test.bvh"));
			reader2 = new Reader(new File("src/main/resources/B_test.bvh"));
			reader3 = new Reader(new File("src/main/resources/C_test.bvh"));
